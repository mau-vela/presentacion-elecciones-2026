...
<!-- BLOQUES DE MAPAS PRE-RENDERIZADOS OCULTOS -->
::: {#mapa-esp-citrep-reg-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("CITREP", "Regional", "Nivel 2026")
```
:::
::: {#mapa-esp-citrep-reg-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("CITREP", "Regional", "Cambio vs 2022")
```
:::
::: {#mapa-esp-citrep-mun-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("CITREP", "Municipal", "Nivel 2026")
```
:::
::: {#mapa-esp-citrep-mun-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("CITREP", "Municipal", "Cambio vs 2022")
```
:::

::: {#mapa-esp-camafro-reg-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Afro", "Regional", "Nivel 2026")
```
:::
::: {#mapa-esp-camafro-reg-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Afro", "Regional", "Cambio vs 2022")
```
:::
::: {#mapa-esp-camafro-reg-c18 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Afro", "Regional", "Cambio vs 2018")
```
:::
::: {#mapa-esp-camafro-mun-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Afro", "Municipal", "Nivel 2026")
```
:::
::: {#mapa-esp-camafro-mun-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Afro", "Municipal", "Cambio vs 2022")
```
:::
::: {#mapa-esp-camafro-mun-c18 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Afro", "Municipal", "Cambio vs 2018")
```
:::

::: {#mapa-esp-senind-reg-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Senado Indígena", "Regional", "Nivel 2026")
```
:::
::: {#mapa-esp-senind-reg-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Senado Indígena", "Regional", "Cambio vs 2022")
```
:::
::: {#mapa-esp-senind-reg-c18 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Senado Indígena", "Regional", "Cambio vs 2018")
```
:::
::: {#mapa-esp-senind-mun-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Senado Indígena", "Municipal", "Nivel 2026")
```
:::
::: {#mapa-esp-senind-mun-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Senado Indígena", "Municipal", "Cambio vs 2022")
```
:::
::: {#mapa-esp-senind-mun-c18 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Senado Indígena", "Municipal", "Cambio vs 2018")
```
:::

::: {#mapa-esp-camind-reg-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Indígena", "Regional", "Nivel 2026")
```
:::
::: {#mapa-esp-camind-reg-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Indígena", "Regional", "Cambio vs 2022")
```
:::
::: {#mapa-esp-camind-reg-c18 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Indígena", "Regional", "Cambio vs 2018")
```
:::
::: {#mapa-esp-camind-mun-26 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Indígena", "Municipal", "Nivel 2026")
```
:::
::: {#mapa-esp-camind-mun-c22 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
crear_mapa_esp("Cámara Indígena", "Municipal", "Cambio vs 2022")
```
:::
::: {#mapa-esp-camind-mun-c18 .esp-mapa style="position:absolute; width:100%; top:0; left:0; transition: opacity 0.3s;"}
```{r}
