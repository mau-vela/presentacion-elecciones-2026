...
sf_mpios  <- readRDS("../datos generales/shapes/muni_simpl_sanandres_cache.rds")$sf_obj
sf_deptos <- readRDS("../datos generales/shapes/departamento_simpl_sanandres_cache.rds")$sf_obj
```
...
mapa_divipole <- function(eleccion_sel) {
  ...
  dp <- sf_deptos %>% mutate(coddepto = as.integer(cod_depto)) %>%
